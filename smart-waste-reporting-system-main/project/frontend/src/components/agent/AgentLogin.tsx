...
const AgentLogin: React.FC<AgentLoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 animate-fade-in">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center animate-slide-up">
          ...
          <h2 className="text-3xl font-bold text-white mb-2 animate-slide-up animation-delay-200">Agent Portal</h2>
          <p className="text-green-200 animate-slide-up animation-delay-400">Waste Collection Team Access</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 animate-slide-up animation-delay-300 hover:shadow-3xl transition-shadow duration-300">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p><strong>Agent ID:</strong> agent</p>
        ...
        <div className="text-center">
          <p className="text-green-200 text-sm">
            Access your assigned pickup tasks and routes
          </p>
        </div>
      </div>
    </div>
